...
with st.form("predict_form"):
    length_minutes = st.number_input("Episode length (minutes)", min_value=0.0, max_value=130.0, value=62.0)
    intro_length_seconds = st.number_input("Intro length (seconds)", min_value=0.0, max_value=230.0, value=113.0)
